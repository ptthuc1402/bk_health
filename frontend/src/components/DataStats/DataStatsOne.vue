...
onMounted(async () => {
  ...
  appoints_length.value = appointments.appointments.length ? appointments.appointments.length : 0
})
...
<template>
  ...
  >
    ...
    <div class="mt-4 flex items-end justify-between">
      <div>
        <h4 class="text-title-md font-bold text-black dark:text-white">totol</h4>
